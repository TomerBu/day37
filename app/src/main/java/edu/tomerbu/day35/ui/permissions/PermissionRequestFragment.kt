 ...
 */
package edu.tomerbu.day35.ui.permissions
...
import edu.tomerbu.day35.BuildConfig
import edu.tomerbu.day35.MainActivity
import edu.tomerbu.day35.R
import edu.tomerbu.day35.databinding.FragmentPermissionRequestBinding
    ...
    override fun onCreateView(
        ...
        when (permissionRequestType) {
            ...
            PermissionRequestType.BACKGROUND_LOCATION -> {
                ...
                throw java.lang.RuntimeException("No Such case in the enum")
            }
        }
